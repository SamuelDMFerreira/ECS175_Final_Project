...
class ShadedObject3D extends Object3D { 
    ...
    createVAO( gl, shader )
    {
        ...
        // The stride stays the same throughout the vertexPointer process for each part so we can just set the overall stride to contain either 6 or 11 elements
        ...
        if (location >= 0 && this.material.hasTexture()) {
            ...
            offset += this.num_components_vec2 * Float32Array.BYTES_PER_ELEMENT
    ...
    render( gl )
    {
        ...
        if (this.material.hasMapKD()) {
            ...
            // Activate current texture and bind it to gl.TEXTURE_2D, then pass it to the uniform in the shader
